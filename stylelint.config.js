module.exports = {
    ...
    rules: {
        ...
        "at-rule-name-case": [
            ...
            {
                message:
                    "Идентификатор правила следует писать строчными буквами",
            },
        ],
        ...
        "declaration-block-trailing-semicolon": [
            ...
            {
                message:
                    "Каждое свойство должно заканчиваться точкой с запятой",
            },
        ],
        ...
        "font-family-name-quotes": [
            ...
            {
                message:
                    "Название шрифта следует брать в кавычки только когда это необходимо",
            },
        ],
        ...
        "function-calc-no-unspaced-operator": [
            ...
            {
                message:
                    "до и после оператора должен быть пробел или перенос на новую строку",
            },
        ],
        ...
        "length-zero-no-unit": [
            ...
            {
                message:
                    "Единицы измерения не указываются, если значение равно нулю",
            },
        ],
        "max-empty-lines": [
            2,
        ...
        "media-query-list-comma-newline-after": [
            ...
            {
                message:
                    "В многострочных медиазапросах должен быть перенос на новую строку после запятой",
            },
        ],
        "media-query-list-comma-newline-before": [
            ...
            {
                message:
                    "В многострочных медиазапросах перед запятой не должно быть переноса на новую строку",
            },
        ],
        "media-query-list-comma-space-after": [
            ...
            {
                message:
                    "В однострочных медиазапросах, после запятой должен быть пробел",
            },
        ],
        "media-query-list-comma-space-before": [
            ...
            {
                message:
                    "В однострочных медиазапросах, перед запятой не должно быть пробела",
            },
        ],
        ...
        "plugin/declaration-block-no-ignored-properties": [
            ...
            {
                message:
                    "Нельзя использовать свойства, которые игнорируются из-за другого значения",
            },
        ],
        "property-case": [
            "lower",
        ...
        "selector-attribute-brackets-space-inside": [
            ...
            {
                message:
                    "В атрибуте селектора между скобками и значением не должно быть пробелов",
            },
        ],
        "selector-attribute-operator-space-after": [
            ...
            {
                message:
                    "В атрибуте селектора после оператора не должно быть пробела",
            },
        ],
        "selector-attribute-operator-space-before": [
            ...
            {
                message:
                    "В атрибуте селектора перед оператором не должно быть пробела",
            },
        ],
        ...
        "selector-combinator-space-after": [
            ...
            {
                message:
                    "При записи нескольких селекторов перед знаком комбинатора должен быть пробел",
            },
        ],
        "selector-combinator-space-before": [
            ...
            {
                message:
                    "При записи нескольких селекторов должеен быть перенос на новую строку",
            },
        ],
        "selector-descendant-combinator-no-non-space": [
            ...
            {
                message:
                    "Комбинированные селекторы нужно отделять одним пробелом",
            },
        ],
        "selector-list-comma-newline-after": [
            ...
            {
                message:
                    "При записи нескольких селекторов должен быть перенос на новую строку",
            },
        ],
        ...
        "selector-max-compound-selectors": [
            ...
            {
                message:
                    "Максимально допустимый составной селектор не должно превышать 10",
            },
        ],
        ...
        "selector-pseudo-class-parentheses-space-inside": [
            ...
            {
                message:
                    "Внутри скобок в псевдоселекторах не должно быть пробелов",
            },
        ],
